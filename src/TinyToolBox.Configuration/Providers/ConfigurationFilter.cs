...
{
    private readonly ImmutableDictionary<Type, Func<KeyValuePair<ConfigurationKey, IConfigurationProvider>, bool>>
        _filters;
    ...
    public ConfigurationFilter(
        IEnumerable<KeyValuePair<Type, Func<KeyValuePair<ConfigurationKey, IConfigurationProvider>, bool>>> filters)
    {
    ...
    {
        return pair.Value is EnvironmentVariablesConfigurationProvider && pair.Key.Depth() > 1;
    }
}
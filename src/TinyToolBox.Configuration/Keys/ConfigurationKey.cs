...
internal readonly struct ConfigurationKey : IEquatable<ConfigurationKey>
{
    ...
    {
        int indexOf = path.IndexOf(ConfigurationPath.KeyDelimiter, prefixLength, StringComparison.OrdinalIgnoreCase);
    ...
    public override bool Equals(object? obj) => obj is not null && obj is ConfigurationKey key && Equals(key);
    ...
    public ConfigurationKey Add(ConfigurationKey other) => new(Path + other.Path);
